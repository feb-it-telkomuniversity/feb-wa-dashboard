...
export default function TindakLanjutMasterList({
    filteredTickets,
    isLoading,
    searchQuery,
    setSearchQuery,
            ...
            <div className="p-4 border-b border-border/50 bg-muted/20">
                ...
                <div className="flex items-center justify-between mt-3 px-1">
                    <span className="text-xs font-medium text-muted-foreground">
                        {filteredTickets.length} Laporan Anda
                    </span>
            ...
            <div className="flex-1 overflow-y-auto p-3 space-y-2 custom-scrollbar">
                {isLoading ? (
                    <div className="flex flex-col items-center justify-center h-full text-muted-foreground">
                        ...
                        <p className="text-sm">Memuat tugas dari Dekan...</p>
                    </div>
                    ...
                    <div className="flex flex-col items-center justify-center h-full text-center p-6">
                        ...
                        <p className="text-xs text-muted-foreground mt-1">
                            Tidak ada tiket yang memerlukan tindak lanjut Unit Anda saat ini.
                        </p>
                    </div>
                ) : (
                    filteredTickets.map((ticket) => {
                        ...
                        // Berikan aksen merah khusus pada kartu jika RevisionNeeded
                        const isUrgent = ticket.status === "RevisionNeeded";
                            ...
                            <div
                                ...
                                className={`
                                    ...
                                    ${isSelected
                                        ...
                                        : isUrgent
                                            ? "bg-rose-500/[0.02] border-rose-500/30 hover:border-rose-500/50 hover:bg-rose-500/[0.05]"
